...
import { FiPieChart, FiBatteryCharging, FiEyeOff, FiTrendingDown, FiAlertTriangle, FiClock } from "react-icons/fi";
...
export default function ProblemStatementSection() {
  ...
  const problems = [
    {
      ...
      description: "Unpredictable surge pricing and incentives make financial planning impossible",
      visual: (
        <div className="mt-4 h-20 bg-gradient-to-r from-red-100 to-red-50 rounded-lg p-3 relative overflow-hidden">
          ...
          <div className="absolute top-1 right-2 text-xs text-red-600 font-semibold">Volatile</div>
        </div>
      )
    },
    {
      icon: <FiBatteryCharging className="w-8 h-8" style={{ color: '#EF4444' }} />,
      title: "Burnout & Fatigue",
      stat: "64%",
      subtitle: "work beyond safe driving hours",
      description: "No personalized rest recommendations lead to dangerous exhaustion",
      visual: (
        <div className="mt-4 h-20 bg-gradient-to-r from-orange-100 to-red-100 rounded-lg p-3 relative">
          ...
          <div className="absolute bottom-1 right-2 text-xs text-red-600 font-semibold">Critical</div>
        </div>
      )
    },
    {
      ...
      description: "Limited access to financial services and planning tools keeps drivers struggling without clear financial visibility.",
      visual: (
        <div className="mt-4 h-20 bg-gradient-to-r from-gray-100 to-slate-100 rounded-lg p-3 relative">
          <div className="flex items-center justify-between h-full">
            <div className="flex-1">
              <div className="text-xs text-gray-700 mb-1">Financial Planning</div>
          ...
          <div className="absolute bottom-1 right-2 text-xs text-gray-600 font-semibold">No Data</div>
        </div>
      )
    },
  ];
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-gradient-to-br from-slate-50 via-white to-red-50/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-slate-600 leading-relaxed max-w-3xl mx-auto">
            Despite being the backbone of the gig economy, drivers face mounting challenges that 
            traditional platforms fail to address. Real problems need real solutions.
          </p>
        </div>
              ...
              <CardContent className="p-8">
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-xs text-slate-500 font-medium">of drivers</div>
                  </div>
                </div>

                {/* Content */}
                <h3 className="text-xl font-bold mb-3 text-slate-800">{problem.title}</h3>
                <p className="text-red-600 font-semibold text-sm mb-2">{problem.subtitle}</p>
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 border border-red-200/50 shadow-xl">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-slate-800 mb-2">The Reality Check</h3>
            <p className="text-slate-600">These aren't just numbers—they represent real drivers struggling daily</p>
          </div>
          ...
          <div className="mt-8 text-center p-6 bg-gradient-to-r from-red-50 to-orange-50 rounded-2xl border border-red-200/50">
            ...
            <p className="text-slate-600">
              FairLeap is built to solve these exact problems with AI-powered insights and personalized support.
            </p>
          </div>
        </div>
      </div>
